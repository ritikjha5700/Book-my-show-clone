...
function PaymentModal({setIsOpen,isOpen ,price}) {

  function closeModal(){
    let bool = window.confirm("Do You want to cancel the Payment");
    if(bool) setIsOpen(false)
  }
  const launchRazorpay = () =>{
    let options = {
      ...
      description: "To accept payment for movie Rental or Buy",
